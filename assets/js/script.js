 ...
 * the returned calucateCorrectAnswer aray
 */
...
function incremenetScore() {
    ...
    document.getElementById("score").innerText = ++oldScore; // ++ means that we will add one
}
...
function incrementWrongAnswer() {
    ...
    document.getElementById("incorrect").innerText = ++oldScore; // ++ means that we will add one
}
...
function displaySubtractQuestion(operand1, operand2) {
    ...
    // or you can use shorthand if/else below
